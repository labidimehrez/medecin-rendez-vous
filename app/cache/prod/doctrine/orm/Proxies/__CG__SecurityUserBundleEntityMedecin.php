...
namespace Proxies\__CG__\SecurityUserBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Medecin extends \SecurityUserBundle\Entity\Medecin implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'SecurityUserBundle\\Entity\\Medecin' . "\0" . 'telephone', '' . "\0" . 'SecurityUserBundle\\Entity\\Medecin' . "\0" . 'nom', '' . "\0" . 'SecurityUserBundle\\Entity\\Medecin' . "\0" . 'adresse', '' . "\0" . 'SecurityUserBundle\\Entity\\Medecin' . "\0" . 'tarif', '' . "\0" . 'SecurityUserBundle\\Entity\\Medecin' . "\0" . 'modepaiments', '' . "\0" . 'SecurityUserBundle\\Entity\\Medecin' . "\0" . 'Specialite', '' . "\0" . 'SecurityUserBundle\\Entity\\Medecin' . "\0" . 'rendezvous', '' . "\0" . 'SecurityUserBundle\\Entity\\Medecin' . "\0" . 'description', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    public function getRendezvous()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRendezvous', array());
    ...
    public function setRendezvous($Rendezvous)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRendezvous', array($Rendezvous));
    ...
    public function getModepaiments()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getModepaiments', array());

        return parent::getModepaiments();
    }
    ...
    public function setModepaiments($modepaiments)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setModepaiments', array($modepaiments));

        return parent::setModepaiments($modepaiments);
    }
