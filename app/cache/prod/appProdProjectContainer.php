...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'medecin-rdv-db', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_fc8841a294287019abb6be96f6ae23d98db7f22fa1cb33cf8d7ce22b0134b1ae');
    ...
    {
        $this->services['monolog.handler.doctrine'] = $instance = new \Monolog\Handler\RotatingFileHandler(($this->targetDirs[2].'\\logs/prod.doctrine.log'), 10, 100, true, NULL);
    ...
    {
        $this->services['monolog.handler.login'] = $instance = new \Monolog\Handler\RotatingFileHandler(($this->targetDirs[2].'\\logs/prod.auth.log'), 10, 200, true, NULL);
    ...
    {
        $this->services['monolog.handler.streamed_error'] = $instance = new \Monolog\Handler\RotatingFileHandler(($this->targetDirs[2].'\\logs/prod.error.log'), 10, 200, true, NULL);
